...
|--------|------|------|-------------|
| `GET` | `/api/version` | ❌ public | Current version + latest GitHub release status. Response: `{ version, gitCommit, latestVersion, releaseURL, changelog?, updateAvailable: bool, checkedAt, error? }` |
