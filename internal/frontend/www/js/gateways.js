...
async createGateway() {
      ...
      try {
        await this.api.createGateway({
          ...
          gatewayIPv6:      (f.gatewayIPv6 || '').trim(),
          monitorAddressV6: (f.monitorAddressV6 || '').trim(),
          monitor:          f.monitor,
...
openGatewayEdit(gw) {
      ...
      this.gatewayEdit = {
        ...
        gatewayIPv6:      gw.gatewayIPv6 || '',
        monitorAddressV6: gw.monitorAddressV6 || '',
        monitor:          gw.monitor,
